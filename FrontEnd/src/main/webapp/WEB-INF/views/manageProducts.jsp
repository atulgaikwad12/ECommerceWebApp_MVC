<%@taglib prefix="sf" uri="http://www.springframework.org/tags/form"%>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8">
				<div class="panel panel-primary"
					style="margin-top: 20px; margin-bottom: 20px; margin-left: 10px; margin-right: 10px;">
					...
					<div class="panel-body">
						...
						<sf:form class="form-horizontal" modelAttribute="product"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input type="text" path="brand" id="brand"
										placeholder="Veg / Non Veg" class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:textarea path="description" id="description" rows="4"
										placeholder="Write something interesting about Product"
										class="form-control" />
							...
							<div class="form-group">
								<label class="control-label col-md-4" for="catid">Select
									Product Category: </label>
								<div class="col-md-8">
									<sf:select path="catid" id="catid" class="form-control"
										items="${categories}" itemLabel="catname" itemValue="catid" />
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input type="number" path="unitprice" id="unitprice"
										placeholder="Product price in rupies ( &#8377 )"
										class="form-control" />
							...
							<div class="form-group">
								<label class="control-label col-md-4" for="quantity">Enter
									Quantity per serve: </label>
								<div class="col-md-8">
									<sf:input type="number" path="quantity" id="quantity"
										maxlength="2" placeholder="Food Quantity per serve"
										class="form-control" />
		...
		<div class="row">
			<div class="col-xs-12">
				<h3>
					<font color="white">Available Products</font>
				</h3>
				<hr />
			</div>
			<div class="col-xs-12">
		...
		<div class="modal fade" id="myCategoryModal" role="dialog"
			tabindex="-1" style="width: 60%; margin-left: 20%; margin-top: 5%;">
						...
						<sf:form id="categoryForm" modelAttribute="category"
							...
							<div class="form-group">
								<label for="cat_name" class="control-label col-md-4">Category
									Name</label>
								<div class="col-md-8">
									<sf:input type="text" path="catname" id="cat_name"
										class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label for="cat_desc" class="control-label col-md-4">Category
									Description</label>
								<div class="col-md-8">
									<sf:textarea cols="" rows="5" path="catdesc" id="cat_desc"
										class="form-control" />
								</div>
							</div>
							<div class="form-group">
